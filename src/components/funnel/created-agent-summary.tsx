    ...
    <Card className="rounded-lg border-white/10 bg-white/[0.05] py-0 shadow-none">
      <CardContent className="p-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm text-white/56">Agent preview</p>
            <h2 className="font-heading text-xl font-semibold tracking-[-0.01em] text-white">{name}</h2>
          </div>
        </div>
        ...
        <p className="mt-5 text-sm leading-7 text-white/66">{summary}</p>
        <div className="mt-6">
        ...
        <div className="mt-5 flex gap-3 rounded-md border border-white/10 bg-black/20 p-3 text-sm text-white/68">

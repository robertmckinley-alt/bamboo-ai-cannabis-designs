        ...
        <Card className="rounded-lg border-white/10 bg-white/[0.045] shadow-none">
          <CardContent className="p-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-white/44">Example agent</p>
                <h2 className="text-xl font-semibold text-white">{industry.agentExamples[0]}</h2>
              </div>
            </div>
            <div className="mt-6 rounded-lg border border-bamboo/20 bg-bamboo/10 p-5">
              <div className="text-4xl font-semibold text-bamboo">{industry.roi.metric}</div>
              <p className="mt-2 font-medium text-white">{industry.roi.label}</p>
              <p className="mt-3 text-sm leading-7 text-white/62">{industry.roi.description}</p>
            </div>
            <div className="mt-5 grid gap-3">
              {industry.workflow.map((step, index) => (
                <div
                  key={step}
                  className="flex items-center gap-3 rounded-md border border-white/10 bg-black/20 p-3 text-sm text-white/68"
                >
          ...
          <Card className="rounded-lg border-white/10 bg-white/[0.045] shadow-none">
            <CardContent className="p-5">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-lg font-semibold text-white">Workflow example</h2>
              </div>
